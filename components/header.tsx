  ...
  return (
    <header className="border-b border-purple-500/20 backdrop-blur-sm h-20 fixed top-0 left-0 right-0 z-50">
      <nav className="w-full mx-auto flex items-center justify-between py-4 px-4">
        ...
        {/* Logos section - moved to right on desktop */}
        <div className="hidden md:flex items-center space-x-6 order-2">
          <div className="flex items-center space-x-6">
            ...
            <Image src="/jt-chpter-logo.png" alt="JT Chapter Logo" width={150} height={45} priority className="h-[50px] w-auto" />
          </div>
        </div>

        {/* Mobile logos (compressed) */}
        <div className="flex md:hidden items-center space-x-2 order-2">
          <Image src="/ieee-logo.png" alt="IEEE Logo" width={70} height={35} priority className="h-[25px] w-auto" />
          <Image src="/ukf-ieee.png" alt="UKF IEEE Logo" width={70} height={35} priority className="h-[35px] w-auto" />
          <Image src="/jt-chpter-logo.png" alt="JT Chapter Logo" width={110} height={35} priority className="h-[25px] w-auto" />
        </div>
